...
with aba1:
    ...
    with colA:
        ...
        st.altair_chart(
            alt.Chart(df_rec).mark_bar().encode(
                x="Tipo",
                y="Valor",
                color="Tipo"
            ),
    ...
    with colB:
        ...
        st.altair_chart(
            alt.Chart(df_des).mark_bar().encode(
                x="Tipo",
                y="Valor",
                color="Tipo"
            ),
    ...
    # =========================
    # 📊 ONDE A EMPRESA PERDE DINHEIRO (MELHORADO)
    # =========================
...
with aba2:
    ...
    df_evolucao["Mes"] = df_evolucao["Data Lançamento"].dt.strftime("%b/%y")
